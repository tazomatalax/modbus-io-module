...
function initiateSensorPopup() {
    showToast('Add Sensor button pressed: initiateSensorPopup() called', 'info', false, 2000);
    console.log('DEBUG: initiateSensorPopup() called');
    ...
    // Calibration UI/logic moved to IO Status section. The following lines are commented out for migration:
    ...
    showToast('Sensor modal should now be visible', 'info', false, 2000);
    console.log('DEBUG: Sensor modal overlay classList after show:', document.getElementById('sensor-modal-overlay').classList);
}
window.initiateSensorPopup = initiateSensorPopup;
